<#
    CMF INTELLIGENT PIPELINE - 02_50-12 Audrey
...
$projectPath = "d:\Work\The Conscious Movie Factory December\🇫🇷 Conscious Movie Factory\inputs\Coach Adele\02_50-12 Audrey"
$projectId = "02_50-12 Audrey"
...
Write-Host "║    CMF INTELLIGENT PIPELINE: 02_50-12 Audrey     ║" -ForegroundColor Magenta
Write-Host "╚══════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
Write-Host ""
...
Run-Step -Name "Diagnose" `
         -CheckFiles @("strategy_brief.json", "😎 02_50-12 Audrey - The Brand Avatar 😎.md") `
         -Command "/cmf-phase1a-diagnose"

Run-Step -Name "Narrative" `
         -CheckFiles @("02_50-12 Audrey_Quote_Manifest.md", "02_50-12 Audrey_Quote_Manifest_Enriched.md", "02_50-12 Audrey_premise_analysis.json") `
...
Run-Step -Name "Sonic" `
         -CheckFiles @("02_50-12 Audrey_sonic_sommelier_brief.md") `
         -Command "/cmf-phase1b-sonic"

Run-Step -Name "Storyboard" `
         -CheckFiles @("02_50-12 Audrey_STORYBOARD_PRIMAL.md", "02_50-12 Audrey_STORYBOARD_STRUCTURED.md", "02_50-12 Audrey_STORYBOARD_VISUAL_POETRY.md") `
         -Command "/cmf-phase1b-storyboard"

Run-Step -Name "Motion" `
         -CheckFiles @("02_50-12 Audrey_GMG_PROMPTS.md", "02_50-12 Audrey_CAC_PROMPTS.md") `
         -Command "/cmf-phase1b-motion"

Run-Step -Name "E-Roll (Cultural DNA)" `
         -CheckFiles @("02_50-12 Audrey_ERoll_Deep_Research_Report.md", "02_50-12 Audrey_ERoll_Search_Queries.json", "02_50-12 Audrey_EROLL_AUTHORIZED.md") `
         -Command "/cmf-eroll"

Run-Step -Name "Authorize" `
         -CheckFiles @("02_50-12 Audrey_PROMPTS_AUTHORIZED.md") `
...
Write-Host ""
Write-Host "✨ PIPELINE COMPLETE FOR 02_50-12 Audrey ✨" -ForegroundColor Green
