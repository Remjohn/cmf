...
$projectPath = "d:\Work\The Conscious Movie Factory December\🇫🇷 Conscious Movie Factory\inputs\Coach Adele\04_50-12 Nina"
...
Write-Host "║    CMF INTELLIGENT PIPELINE: 04_50-12 Nina     ║" -ForegroundColor Magenta
Write-Host "╚══════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
Write-Host ""
...
Run-Step -Name "Diagnose" `
         -CheckFiles @("strategy_brief.json", "😎 04_50-12 Nina - The Brand Avatar 😎.md") `
...
Write-Host ""
Write-Host "✨ PIPELINE COMPLETE FOR 04_50-12 Nina ✨" -ForegroundColor Green
