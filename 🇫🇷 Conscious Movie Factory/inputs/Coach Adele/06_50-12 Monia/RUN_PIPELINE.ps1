...
$projectPath = "d:\Work\The Conscious Movie Factory December\🇫🇷 Conscious Movie Factory\inputs\Coach Adele\06_50-12 Monia"
...
Write-Host "║    CMF INTELLIGENT PIPELINE: 06_50-12 Monia     ║" -ForegroundColor Magenta
Write-Host "╚══════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
Write-Host ""
...
Run-Step -Name "Diagnose" `
         -CheckFiles @("strategy_brief.json", "😎 06_50-12 Monia - The Brand Avatar 😎.md") `
...
Write-Host ""
Write-Host "✨ PIPELINE COMPLETE FOR 06_50-12 Monia ✨" -ForegroundColor Green
