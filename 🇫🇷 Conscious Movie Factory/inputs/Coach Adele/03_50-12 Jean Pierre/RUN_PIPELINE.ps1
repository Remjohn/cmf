<#
    CMF INTELLIGENT PIPELINE - 03_50-12 Jean Pierre
...
$projectPath = "d:\Work\The Conscious Movie Factory December\🇫🇷 Conscious Movie Factory\inputs\Coach Adele\03_50-12 Jean Pierre"
$projectId = "03_50-12 Jean Pierre"
...
Write-Host "║    CMF INTELLIGENT PIPELINE: 03_50-12 Jean Pierre     ║" -ForegroundColor Magenta
Write-Host "╚══════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
Write-Host ""
...
Run-Step -Name "Diagnose" `
         -CheckFiles @("strategy_brief.json", "😎 03_50-12 Jean Pierre - The Brand Avatar 😎.md") `
         -Command "/cmf-phase1a-diagnose"

Run-Step -Name "Narrative" `
         -CheckFiles @("03_50-12 Jean Pierre_Quote_Manifest.md", "03_50-12 Jean Pierre_Quote_Manifest_Enriched.md", "03_50-12 Jean Pierre_premise_analysis.json") `
...
Run-Step -Name "Sonic" `
         -CheckFiles @("03_50-12 Jean Pierre_sonic_sommelier_brief.md") `
         -Command "/cmf-phase1b-sonic"

Run-Step -Name "Storyboard" `
         -CheckFiles @("03_50-12 Jean Pierre_STORYBOARD_PRIMAL.md", "03_50-12 Jean Pierre_STORYBOARD_STRUCTURED.md", "03_50-12 Jean Pierre_STORYBOARD_VISUAL_POETRY.md") `
         -Command "/cmf-phase1b-storyboard"

Run-Step -Name "Motion" `
         -CheckFiles @("03_50-12 Jean Pierre_GMG_PROMPTS.md", "03_50-12 Jean Pierre_CAC_PROMPTS.md") `
         -Command "/cmf-phase1b-motion"

Run-Step -Name "E-Roll (Cultural DNA)" `
         -CheckFiles @("03_50-12 Jean Pierre_ERoll_Deep_Research_Report.md", "03_50-12 Jean Pierre_ERoll_Search_Queries.json", "03_50-12 Jean Pierre_EROLL_AUTHORIZED.md") `
         -Command "/cmf-eroll"

Run-Step -Name "Authorize" `
         -CheckFiles @("03_50-12 Jean Pierre_PROMPTS_AUTHORIZED.md") `
...
Write-Host ""
Write-Host "✨ PIPELINE COMPLETE FOR 03_50-12 Jean Pierre ✨" -ForegroundColor Green
